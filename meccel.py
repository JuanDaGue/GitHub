...
def conicaEspacio(Omega=0,i=0,omega=0,figsize=(4,4)):
    ...
    #Puntos de la cónica en el sistema natural de referencia
    ...
    #Nótese que en el caso de la cónica, el sistema natural 
    ...
    #Defino desde dónde voy a ver la cónica
    ax.view_init(h,A)
...
def sol2rot(rs,vs,masas,Nt,N,i1,i2):
    ...
    # Rota cada una de las posiciones para encontrar la posición en el sistema rotante
